 ...
 * {@link edu.baylor.ecs.cloudhubs.rad.service.ResourceService#getResourcePaths(String)}, {@link edu.baylor.ecs.cloudhubs.rad.service.ResourceService#getProperties(String, String)} and
 * {@link edu.baylor.ecs.cloudhubs.rad.service.ResourceService#getCtClasses(String, String)}.
 *
 * @author Jan Svacina
 * @version 1.1
 * @since 0.3.0
...
public class ResourceService {
    ...
    /**
     * Constructor for {@link edu.baylor.ecs.cloudhubs.rad.service.ResourceService} which injects a {@link ResourceLoader}
     *
     ...
     * for the {@link edu.baylor.ecs.cloudhubs.rad.service.ResourceService}.
     *
     ...
     * files from the microservice. This method is an entry point for the {@link edu.baylor.ecs.cloudhubs.rad.service.ResourceService}.
     *
     ...
     * JAR file. This method is an entry point for the {@link edu.baylor.ecs.cloudhubs.rad.service.ResourceService}.
     *
     ...
     * {@link edu.baylor.ecs.cloudhubs.rad.service.ResourceService#getProperties(String, String)} and by {@link edu.baylor.ecs.cloudhubs.rad.service.ResourceService#getCtClasses(String, String)}.
     *
     ...
     * helper method used by {@link edu.baylor.ecs.cloudhubs.rad.service.ResourceService#getProperties(String, String)} and by
     * {@link edu.baylor.ecs.cloudhubs.rad.service.ResourceService#getClassFileSet(Resource, String)}.
     *
     ...
     * helper method used by {@link edu.baylor.ecs.cloudhubs.rad.service.ResourceService#getClassFileSet(Resource, String)}.
     *
